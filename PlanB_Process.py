...
def planb_processing(student_id, courses, major_name, plan):
...
def sorting_PlanB_majors(enrollment_history, major_name, plan):
    student_id_list = []
    ...
    for student_id in student_id_list:
        ...
        """
        # print(major_name)
        planb_processing(student_id=student_id, courses=enrollment_history, major_name=major_name, plan=plan)